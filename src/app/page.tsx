...
export default function HomePage() {
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-gradient-to-tr from-black via-zinc-900 to-red-950 flex flex-col items-center px-6 text-center pt-24">
      {/* Анимирана позадина */}
      <AnimatedBackground />
      ...
      <img
        ...
        className="z-10 mb-8 w-36 h-auto object-contain select-none drop-shadow-[0_0_8px_rgba(255,0,0,0.4)]"
      />
